...
- [ ] Nothing that writes outside this process defaults to on.
- [ ] A known-bad row in the live store was repaired, not preserved — or there was none, and the query showing that is in the body.
