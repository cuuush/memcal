...
SIGNAL = [
    ...
    dict(id="wadm02", day=2, time="08:44", src="wa", thread="Rae", who="me", beat=None,
         text="he sleeps for like six hours after, worth it"),
    dict(id="wadm03", day=2, time="08:46", src="wa", thread="Rae", who="Rae", beat=None,
         text="ha. the little one wore herself out too"),
    ...
    dict(id="el01", day=1, time="19:12", src="gm", thread="rave chat",
         ...
         text="Solstice Music Festival is Friday August 7 through Sunday August 9 at "
              "Rivertown. Casey and I are going; that doesn't mean everyone in this "
              "chat is going"),
    ...
    #    called "Solstice" and read as three unrelated plans on one weekend.
    dict(id="el30", day=3, time="13:20", src="gm", thread="rave chat", who="Alex Rivera",
         beat="solstice.breakfast",
         say="says a few of them are doing breakfast at solstice saturday morning, "
    ...
    dict(id="el31", day=3, time="13:22", src="gm", thread="rave chat", who="me",
         beat="solstice.breakfast", say="the user's in for breakfast"),
]
...
ACTIONS = [
    ...
    #     Solstice row that motivated the relationship-aware bundle context.
    dict(id="ac05", day=1, time="08:00", beat="existing-group-event",
         call="add_event",
         args=dict(title="Solstice Music Festival", when="2026-08-07",
