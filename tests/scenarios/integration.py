...
DAY1 = {
    ...
    "thread:groupme:rave chat": _diff(events=[
        ...
        {
            "key": "solstice-music-festival@2026-08-07",
            "title": "Solstice Music Festival", "date": "2026-08-07",
            "until": "2026-08-09", "kind": "commitment", "status": "confirmed",
            "subject": "me", "location": "Rivertown",
...
DAY3 = {
    ...
    "thread:groupme:rave chat": _diff(events=[{
        "title": "Breakfast at Solstice", "date": SAT, "time": "09:00",
        "kind": "commitment", "status": "confirmed", "subject": "me",
        "participants": ["Alex Rivera"],
    }]),
