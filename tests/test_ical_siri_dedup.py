...
class TestNearDuplicateTitlesStaySeparate(Base):
    ...
    def test_close_but_different_titles_stay_two_rows(self):
        ...
        _snapshot(self, [
            ...
            _item("c-1", "Solstice", 5),
            _item("c-2", "Breakfast at Solstice", 5),
        ])
        ...
        self.assertEqual(
            len([t for t in titles if t in ("Solstice", "Breakfast at Solstice")]), 2,
            '"Solstice" must never absorb into "Breakfast at Solstice"')
