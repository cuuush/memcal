...
class TestMailIsIncludedByDefaultAndRankedNotDropped(Base):
    ...
    def test_a_reply_joins_its_own_conversation_and_a_new_subject_does_not(self):
        ...
        self._deliver(1, self._message("trust-1@adv.example", "Trust meeting",
                                       sender="advisor@adv.example"), mailbox)
        self._deliver(2, self._message("trust-2@adv.example", "Re: Trust meeting",
                                       sender="advisor@adv.example",
                                       reply_to="trust-1@adv.example"), mailbox)
...
class TestNormalisingMessageIdsDoesNotDuplicateArchivedMail(Base):
    ...
    def test_a_reply_joins_an_ancestor_archived_under_the_old_spelling(self):
        archive.append(
            ...
            ts="2026-09-07T10:00:00", text="Trust meeting", thread="root@example.com",
