...
class TestANumeralIsNotAName(Base):
    ...
    def test_a_handle_no_platform_can_name_says_where_it_speaks(self):
        ...
        self.assertEqual(["Family"],
                         identity.where_seen(self.conn, "whatsapp:lid:100000000000200"))
...
class TestALinkedIdIsNotAPhoneNumber(Base):
    ...
    def test_a_lid_does_not_become_a_phone_number(self):
        self.assertIsNone(whatsapp.phone_of("100000000000200@lid"))
        self.assertEqual("whatsapp:lid:100000000000200",
                         whatsapp.handle_of("100000000000200@lid"))
...
class TestARosterScanOverwroteAJudgement(Base):
    ...
    def test_a_scan_cannot_replace_a_contact_match(self):
        ...
        identity.link(self.conn, "+17325550114", "devin reyes", source="contacts")
        self.conn.commit()
...
class TestTwoCasingsOfOneNameAreTwoPeople(Base):
    ...
    def test_no_caller_has_to_remember_to_ask(self):
        ...
        identity.link(self.conn, "+14845550110", "sid", source="contacts")
        self.conn.commit()
    ...
    def test_the_store_never_holds_two_spellings_of_one_person(self):
        ...
        for handle, person, source in (("+17325550114", "devin reyes", "contacts"),
                                       ("groupme:20141029", "Devin Reyes", "groupme:profile"),
                                       ("+19085550116", "andrew whitehouse", "contacts"),
    ...
    def test_the_better_evidence_picks_the_surviving_spelling(self):
        ...
        self.conn.executemany(
            ...
            [("groupme:1", "SID", "groupme:profile", db.now()),
             ("+14845550110", "sid", "contacts", db.now())])
        self.conn.commit()
        identity.collapse_split_spellings(self.conn)
...
class TestMCPAnswerClosesTodosConversationally(Base):
    ...
    def test_answering_something_already_settled_counts_as_recorded(self):
        ...
        out = self._server().call(
            "memcal_answer",
            {"question": "Mail the signed paperwork back",
