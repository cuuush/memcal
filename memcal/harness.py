...
A row flagged with new activity may have changed — open it with memcal_open
before giving current details for it; the open already includes the new messages.
