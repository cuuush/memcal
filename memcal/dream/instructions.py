...
The message timestamp is context, never the date of a plan. "Ready to pick up" or "stop
by anytime" with no scheduled day is an open to-do with no due date, not an event on the
