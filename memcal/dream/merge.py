...
def _tokens(title: str) -> set[str]:
    """Distinctive words, singularised. "Bier gardens" and "Beer garden at Harborview
...
def same_event(a: Mention, b: Mention, cfg: Config | None = None,
    ...
    # "Beer garden at Harborview Hall": not one word in common, the same two guests, the
...
def _corroborate(row: dict, voices: int) -> None:
    ...
    # for the user to read — the user saw "Beer garden · Harborview Hall, Midtown · 2 sources
