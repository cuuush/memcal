...
class Event:
    ...
    def plain_state(self) -> str:
        ...
        if self.kind == "opportunity":
            ...
            # going to rendered "could go" for days: "why is solstice showing up as
...
def find_match_scored(
    ...
    *,
    ...
    for ev, ordinal, distance, tier, absorbs in seen:
        ...
        # identity. "Breakfast at Solstice" on the Saturday of a Friday-to-Sunday
        ...
        # date, and "Breakfast at Solstice" is not a subset of "Solstice Music Festival"
    ...
    *,
    ...
    for name in MUTABLE:
        ...
        if name in inferred and _claimed_by_another(conn, existing.id, name, written_by):
            ...
            # an opportunity again — "why is solstice showing up as could go. im
        ...
        if name == "date" and confidence <= 1:
            ...
            # passing "next weekend" in an unrelated thread about paperwork.
            continue
